         ...
         >
            <div className="footer">
               <div>
                  ...
                  <Link to={"/services/Medical"} className="link link-hover">
                     Medical
                  </Link>
                  <Link to={"/services/Consultant"} className="link link-hover">
                     Consultant
                  </Link>
                  <Link to={"/services/Therapist"} className="link link-hover">
                     Therapist
                  </Link>
                  <Link to={"/services/Physiologist"} className="link link-hover">
                     Physiologist
                  </Link>
               </div>
               <div>
               ...
               <div className="text-center ">
                  ...
                  <div className="flex justify-center my-5">
                     ...
                     <div className="flex bg-gray-700 items-center border rounded-lg px-4 py-2 mx-2">
                        ...
                        <p className='text-4xl text-white'>icons</p>
